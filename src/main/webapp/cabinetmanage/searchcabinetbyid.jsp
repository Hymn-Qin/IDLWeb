...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#back").button();
		$("#add").button();
		$("#add").click(function() {$("#form1").attr("action", "checkcabinetid.action").submit();});
	});
...
<body style=" background:#eef2fb;">
	...
	<table cellspacing=0 cellpadding=0 width="99%" align=center border=1
		...
		<%
			int i = 0;
			if (checkcabinetinfo != null && checkcabinetinfo.size() > 0) {
				Iterator itor = checkcabinetinfo.iterator();
				while (itor.hasNext()) {
...
var fristpage=1;
$("#lastPage").attr("href","checkcabinetid.action?pageInfo.nextPage="+pagetotal+"");
$("#nextPage").attr("href","checkcabinetid.action?pageInfo.nextPage="+pagenext+"");
$("#prePage").attr("href","checkcabinetid.action?pageInfo.nextPage="+pagebefore+"");
$("#firstPage").attr("href","checkcabinetid.action?pageInfo.pageNum="+fristpage+"");
	  });
 </script>
</html>